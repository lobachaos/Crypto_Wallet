...
class WalletsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wallet" do
    assert_difference('Wallet.count') do
      post wallets_url, params: { wallet: { descryption: @wallet.descryption, user_id: @wallet.user_id, wallet_budget: @wallet.wallet_budget } }
    end
  ...
  test "should update wallet" do
    patch wallet_url(@wallet), params: { wallet: { descryption: @wallet.descryption, user_id: @wallet.user_id, wallet_budget: @wallet.wallet_budget } }
